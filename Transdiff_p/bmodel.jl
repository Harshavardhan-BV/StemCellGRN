...
function bmodel(topoFile::String; nInit::Int64=10000, nIter::Int64=1000,
    ...
    Tn_file_name = replace(topoFile, ".topo" => "")
    if shubham == true
        ...
        if nonMatrix
            ...
            if stateRep == -1
                if randSim
                    ...
                    state_df, frust_df = asyncUpdate(update_matrix, nInit, nIter, Tn_file_name)
                end
            else
...
function bmodel_reps(topoFile::String; nInit::Int64=10000, nIter::Int64=1000,
    ...
    types::Array{Int, 1} = [0],init::Bool=true, randSim::Bool=false, root::String="", 
